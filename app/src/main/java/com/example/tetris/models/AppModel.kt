...
import com.example.tetris.models.AppModel.Statuses.*
import com.example.tetris.models.constants.CellConstants
import com.example.tetris.models.constants.FieldConstants
...
class AppModel {
    ...
    var currentState: String = AWAITING_START.name
    ...
    fun isGameOver(): Boolean {
        return currentState == OVER.name
    }

    fun isGameActive(): Boolean {
        return currentState == ACTIVE.name
    }

    fun isGameAwaitingStart(): Boolean {
        return currentState == AWAITING_START.name
    }
